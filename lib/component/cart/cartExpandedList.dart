...
class CartExpandedList extends StatefulWidget {
...
CartExpandedList(this.item, this.colorList, this.openParticularItem, this.removeItemAlertBox);
@override
_CartExpandedListState createState() => _CartExpandedListState();
}

class _CartExpandedListState extends State<CartExpandedList> {
  @override
